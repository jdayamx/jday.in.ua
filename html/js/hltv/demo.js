Demo = function( file ) {
	...
	//this._commandListener = document.createElement( 'div' );
}

/*Demo.prototype.addCommandListener( command, callback ) {
	this._commandListener.addEventListener( command, function( event ) {
		event.data.command =
	} );
}*/
