...
! function(e, t) {
    function r(e) {
        var t = e.length,
            r = oe.type(e);
        return oe.isWindow(e) ? !1 : 1 === e.nodeType && t ? !0 : "array" === r || "function" !== r && (0 === t || "number" == typeof t && t > 0 && t - 1 in e)
    }

    function i(e) {
        var t = de[e] = {};
        oe.each(e.match(se) || [], function(e, r) {
            t[r] = !0
        });
        return t
    }
    ...
    function o(e, r, i) {
        var n;
        if (i === t && 1 === e.nodeType) {
            n = "data-" + r.replace(ve, "-$1").toLowerCase();
            i = e.getAttribute(n);
            if ("string" == typeof i) {
                try {
    ...
    function d(e, t) {
        for (var r = e.length, i = 0; r > i; i++) Ee.set(e[i], "globalEval", !t || Ee.get(t[i], "globalEval"))
    }
    ...
    function E(e, r) {
        ...
        return r === t || r && oe.nodeName(e, r) ? oe.merge([e], i) : i
    }

    function g(e, t) {
        var r = t.nodeName.toLowerCase();
        "input" === r && Ue.test(e.type) ? t.checked = e.checked : ("input" === r || "textarea" === r) && (t.defaultValue = e.defaultValue)
    }

    function v(e, t) {
        if (t in e) return t;
        for (var r = t.charAt(0).toUpperCase() + t.slice(1), i = t, n = Je.length; n--;) {
            t = Je[n] + r;
            if (t in e) return t
        }
        return i
    ...
    function R(e, t) {
        for (var r, i, n, o = [], a = 0, s = e.length; s > a; a++) {
            i = e[a];
            if (i.style) {
                o[a] = Ee.get(i, "olddisplay");
                r = i.style.display;
                if (t) {
                    o[a] || "none" !== r || (i.style.display = "");
                    "" === i.style.display && y(i) && (o[a] = Ee.access(i, "olddisplay", b(i.nodeName)))
                } else if (!o[a]) {
                    n = y(i);
                    (r && "none" !== r || !n) && Ee.set(i, "olddisplay", n ? r : oe.css(i, "display"))
                }
            }
        }
        for (a = 0; s > a; a++) {
    ...
    function H(e, t, r, i, n) {
        for (var o = r === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) {
            "margin" === r && (a += oe.css(e, r + Ze[o], !0, n));
            if (i) {
                "content" === r && (a -= oe.css(e, "padding" + Ze[o], !0, n));
                "margin" !== r && (a -= oe.css(e, "border" + Ze[o] + "Width", !0, n))
            } else {
                a += oe.css(e, "padding" + Ze[o], !0, n);
                "padding" !== r && (a += oe.css(e, "border" + Ze[o] + "Width", !0, n))
            }
        }
        return a
    }
    ...
    function w(e, t, r) {
        ...
        if (0 >= n || null == n) {
            ...
            if (qe.test(n)) return n;
            i = a && (oe.support.boxSizingReliable || n === e.style[t]);
            n = parseFloat(n) || 0
        }
    ...
    function b(e) {
        ...
        if (!r) {
            r = _(e, t);
            if ("none" === r || !r) {
                je = (je || oe("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement);
    ...
    function S(e, t, r, i) {
        ...
        if (oe.isArray(t)) oe.each(t, function(t, n) {
            r || tt.test(e) ? i(e, n) : S(e + "[" + ("object" == typeof n ? t : "") + "]", n, r, i)
        });
        else if (r || "object" !== oe.type(t)) i(e, t);
        else
            for (n in t) S(e + "[" + n + "]", t[n], r, i)
    }
    ...
    function D(e, r, i) {
        for (var n, o, a, s, l = e.contents, c = e.dataTypes;
            "*" === c[0];) {
            c.shift();
            n === t && (n = e.mimeType || r.getResponseHeader("Content-Type"))
        }
        if (n)
            for (o in l)
                if (l[o] && l[o].test(n)) {
    ...
    function F(e, t, r) {
        for (var i, n = (Pt[t] || []).concat(Pt["*"]), o = 0, a = n.length; a > o; o++)
    ...
    function N(e, t, r) {
        var i, n, o = 0,
            ...
            l = function() {
                if (n) return !1;
                for (var t = St || P(), r = Math.max(0, c.startTime + c.duration - t), i = r / c.duration || 0, o = 1 - i, a = 0, l = c.tweens.length; l > a; a++) c.tweens[a].run(o);
            ...
            h = c.props;
        U(h, c.opts.specialEasing);
        for (; a > o; o++) {
            i = Lt[o].call(c, e, h, c.opts);
            if (i) return i
        }
        oe.map(h, F, c);
    ...
    function V(e, r, i) {
        ...
        if (!i.queue) {
            ...
            h.always(function() {
                h.always(function() {
                    l.unqueued--;
                    oe.queue(e, "fx").length || l.empty.fire()
                })
            })
        }
        if (1 === e.nodeType && ("height" in r || "width" in r)) {
            i.overflow = [f.overflow, f.overflowX, f.overflowY];
            "inline" === oe.css(e, "display") && "none" === oe.css(e, "float") && (f.display = "inline-block")
        }
        if (i.overflow) {
            f.overflow = "hidden";
            h.always(function() {
        ...
        for (n in r) {
            ...
            if (Ct.exec(o)) {
                ...
                a = a || "toggle" === o;
                if (o === (p ? "hide" : "show")) {
                    if ("show" !== o || !d || d[n] === t) continue;
                    p = !0
                }
                u[n] = d && d[n] || oe.style(e, n)
            }
        }
        if (!oe.isEmptyObject(u)) {
            d ? "hidden" in d && (p = d.hidden) : d = Ee.access(e, "fxshow", {});
            a && (d.hidden = !p);
            p ? oe(e).show() : h.done(function() {
                oe(e).hide()
            });
            h.done(function() {
                var t;
    ...
    var k, I, j = typeof t,
        ...
        pe = function() {
            W.removeEventListener("DOMContentLoaded", pe, !1);
            e.removeEventListener("load", pe, !1);
            oe.ready()
        };
    oe.fn = oe.prototype = {
        jquery: Q,
        ...
        init: function(e, r, i) {
            ...
            if (!e) return this;
            if ("string" == typeof e) {
                n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : le.exec(e);
                if (!n || !n[1] && r) return !r || r.jquery ? (r || i).find(e) : this.constructor(r).find(e);
                if (n[1]) {
                    r = r instanceof oe ? r[0] : r;
                    oe.merge(this, oe.parseHTML(n[1], r && r.nodeType ? r.ownerDocument || r : W, !0));
                    if (ce.test(n[1]) && oe.isPlainObject(r))
                        for (n in r) oe.isFunction(this[n]) ? this[n](r[n]) : this.attr(n, r[n]);
                    return this
                }
                o = W.getElementById(n[2]);
                if (o && o.parentNode) {
                    this.length = 1;
                    this[0] = o
                }
            ...
            if (oe.isFunction(e)) return i.ready(e);
            if (e.selector !== t) {
        ...
        for (; c > l; l++)
            if (null != (e = arguments[l]))
                for (r in e) {
                    ...
                    n = e[r];
                    if (s !== n)
                        if (h && n && (oe.isPlainObject(n) || (o = oe.isArray(n)))) {
                            if (o) {
                                o = !1;
                                a = i && oe.isArray(i) ? i : []
                            } else a = i && oe.isPlainObject(i) ? i : {};
                            s[r] = oe.extend(h, a, n)
                        } else n !== t && (s[r] = n)
                }
            return s
    ...
    oe.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--oe.readyWait : !oe.isReady) {
                ...
                if (!(e !== !0 && --oe.readyWait > 0)) {
                    I.resolveWith(W, [oe]);
                    oe.fn.trigger && oe(W).trigger("ready").off("ready")
                }
            }
        },
        ...
        type: function(e) {
            return null == e ? String(e) : "object" == typeof e || "function" == typeof e ? $[re.call(e)] || "object" : typeof e
        },
        ...
        parseXML: function(e) {
            ...
            try {
                i = new DOMParser;
                r = i.parseFromString(e, "text/xml")
            } catch (n) {
                r = t
            }(!r || r.getElementsByTagName("parsererror").length) && oe.error("Invalid XML: " + e);
            return r
        },
        noop: function() {},
        globalEval: function(e) {
            ...
            if (e)
                if (1 === e.indexOf("use strict")) {
                    t = W.createElement("script");
                    t.text = e;
                    W.head.appendChild(t).parentNode.removeChild(t)
                } else r(e)
        },
        camelCase: function(e) {
            return e.replace(he, "ms-").replace(ue, fe)
        },
        ...
        makeArray: function(e, t) {
            var i = t || [];
            null != e && (r(Object(e)) ? oe.merge(i, "string" == typeof e ? [e] : e) : J.call(i, e));
            return i
        },
        inArray: function(e, t, r) {
            return null == t ? -1 : te.call(t, e, r)
        },
        merge: function(e, r) {
            var i = r.length,
                n = e.length,
        ...
        proxy: function(e, r) {
            ...
            o = function() {
                return e.apply(r || this, n.concat(ee.call(arguments)))
            };
        ...
        access: function(e, r, i, n, o, a, s) {
            ...
            if ("object" === oe.type(i)) {
                o = !0;
                for (l in i) oe.access(e, r, l, i[l], !0, a, s)
            } else if (n !== t) {
                o = !0;
                oe.isFunction(n) || (s = !0);
                if (h)
                    if (s) {
                        ...
                        h = r;
                        r = function(e, t, r) {
                            return h.call(oe(e), r)
                        }
                    }
                if (r)
                    for (; c > l; l++) r(e[l], i, s ? n : n.call(e[l], l, r(e[l], i)))
            }
    ...
    oe.ready.promise = function(t) {
        if (!I) {
            I = oe.Deferred();
            if ("complete" === W.readyState) setTimeout(oe.ready);
            else {
                W.addEventListener("DOMContentLoaded", pe, !1);
                e.addEventListener("load", pe, !1)
            }
        }
        return I.promise(t)
    };
    ...
    ! function(e, t) {
        function r(e, t, r, i) {
            ...
            if (F && !i) {
                if (n = ye.exec(e))
                    if (a = n[1]) {
                        ...
                        if (n[2]) {
                            ee.apply(r, t.getElementsByTagName(e));
                            return r
                        }
                        if ((a = n[3]) && H.getElementsByClassName && t.getElementsByClassName) {
                            ee.apply(r, t.getElementsByClassName(a));
                            return r
                        }
                    }
                if (H.qsa && (!N || !N.test(e))) {
                    ...
                    if (1 === s && "object" !== t.nodeName.toLowerCase()) {
                        c = f(e);
                        (h = t.getAttribute("id")) ? u = h.replace(xe, "\\$&"): t.setAttribute("id", u);
                        u = "[id='" + u + "'] ";
                        l = c.length;
                        for (; l--;) c[l] = u + p(c[l]);
                        d = pe.test(e) && t.parentNode || t;
                        m = c.join(",")
                    }
                    if (m) try {
                        ee.apply(r, d.querySelectorAll(m));
                        return r
                    } catch (E) {} finally {
            ...
            return R(e.replace(he, "$1"), t, r, i)
        }

        function i() {
            function e(r, i) {
                t.push(r += " ") > b.cacheLength && delete e[t.shift()];
                return e[r] = i
            }
            var t = [];
            return e
        ...
        function a(e, t) {
            for (var r = e.split("|"), i = e.length; i--;) b.attrHandle[r[i]] = t
        }

        function s(e, t) {
            var r = t && e,
                i = r && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || $) - (~e.sourceIndex || $);
            if (i) return i;
            if (r)
                for (; r = r.nextSibling;)
                    if (r === t) return -1;
        ...
        function f(e, t) {
            ...
            return t ? s.length : s ? r.error(e) : G(e, l).slice(0)
        }
        ...
        function g(e, t, r, i, o, a) {
            i && !i[B] && (i = g(i));
            o && !o[B] && (o = g(o, a));
            return n(function(n, a, s, l) {
                var c, h, u, f = [],
                    p = [],
                    d = a.length,
                    m = n || T(t || "*", s.nodeType ? [s] : s, []),
                    g = !e || !n && t ? m : E(m, f, e, s, l),
                    v = r ? o || (n ? e : d || i) ? [] : a : g;
                r && r(g, v, s, l);
                if (i) {
                    c = E(v, p);
                ...
                if (n) {
                    if (o || e) {
                        if (o) {
                            c = [];
                            h = v.length;
                            for (; h--;)(u = v[h]) && c.push(g[h] = u);
                            o(null, v = [], c, l)
                        }
                        h = v.length;
                        for (; h--;)(u = v[h]) && (c = o ? re.call(n, u) : f[h]) > -1 && (n[c] = !(a[c] = u))
                    }
                } else {
                    v = E(v === a ? v.splice(d, v.length) : v);
        ...
        function v(e) {
            for (var t, r, i, n = e.length, o = b.relative[e[0].type], a = o || b.relative[" "], s = o ? 1 : 0, l = d(function(e) {
                ...
                if (r = b.relative[e[s].type]) h = [d(m(h), r)];
                else {
                    r = b.filter[e[s].type].apply(null, e[s].matches);
                    if (r[B]) {
                        i = ++s;
                        for (; n > i && !b.relative[e[i].type]; i++);
                        return g(s > 1 && m(h), s > 1 && p(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(he, "$1"), r, i > s && v(e.slice(s, i)), n > i && v(e = e.slice(i)), n > i && p(e))
                    }
                    h.push(r)
                }
            return m(h)
            ...
            var i = 0,
                ...
                s = function(n, s, l, c, h) {
                    var u, f, p, d = [],
                        ...
                        y = null != h,
                        T = C,
                        R = n || a && b.find.TAG("*", h && s.parentNode || s),
                        x = k += null == T ? 1 : Math.random() || .1;
                    if (y) {
                        C = s !== L && s;
                        w = i
                    }
                    ...
                    if (o && g !== m) {
                        ...
                        if (n) {
                            if (m > 0)
                                for (; g--;) v[g] || d[g] || (d[g] = Z.call(c));
                            d = E(d)
                        }
                        ee.apply(c, d);
                        y && !n && d.length > 0 && m + t.length > 1 && r.uniqueSort(c)
                    }
                    if (y) {
                        k = x;
                        C = T
        ...
        function T(e, t, i) {
            for (var n = 0, o = t.length; o > n; n++) r(e, t[n], i);
            return i
        }
        ...
        function R(e, t, r, i) {
            ...
            if (!i && 1 === c.length) {
                o = c[0] = c[0].slice(0);
                if (o.length > 2 && "ID" === (a = o[0]).type && H.getById && 9 === t.nodeType && F && b.relative[o[1].type]) {
                    t = (b.find.ID(a.matches[0].replace(He, we), t) || [])[0];
                    if (!t) return r;
                    e = e.slice(o.shift().value.length)
                }
                n = ge.needsContext.test(e) ? 0 : o.length;
                for (; n--;) {
                    a = o[n];
                    if (b.relative[s = a.type]) break;
                    if ((l = b.find[s]) && (i = l(a.matches[0].replace(He, we), pe.test(o[0].type) && t.parentNode || t))) {
                        o.splice(n, 1);
                        e = i.length && p(o);
                        if (!e) {
                            ee.apply(r, i);
            ...
            M(e, c)(i, t, !F, r, pe.test(e));
            return r
        }
        var x, H, w, b, _, S, M, C, A, D, L, P, F, N, U, V, z, B = "sizzle" + -new Date,
            O = e.document,
            k = 0,
            I = 0,
            j = i(),
        ...
        D = r.setDocument = function(e) {
            var t = e ? e.ownerDocument || e : O,
                r = t.defaultView;
            if (t === L || 9 !== t.nodeType || !t.documentElement) return L;
            L = t;
            P = t.documentElement;
            F = !S(t);
            ...
            U = [];
            N = [];
            if (H.qsa = ve.test(t.querySelectorAll)) {
                o(function(e) {
                    e.innerHTML = "<select><option selected=''></option></select>";
                    e.querySelectorAll("[selected]").length || N.push("\\[" + ne + "*(?:value|" + ie + ")");
                    e.querySelectorAll(":checked").length || N.push(":checked")
                });
                o(function(e) {
                    var r = t.createElement("input");
                    r.setAttribute("type", "hidden");
                    e.appendChild(r).setAttribute("t", "");
                    e.querySelectorAll("[t^='']").length && N.push("[*^$]=" + ne + "*(?:''|\"\")");
                    e.querySelectorAll(":enabled").length || N.push(":enabled", ":disabled");
                    e.querySelectorAll("*,:x");
                    N.push(",.*:")
                })
            }(H.matchesSelector = ve.test(V = P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && o(function(e) {
                H.disconnectedMatch = V.call(e, "div");
                V.call(e, "[s!='']:x");
                U.push("!=", ce)
            });
            N = N.length && new RegExp(N.join("|"));
            U = U.length && new RegExp(U.join("|"));
            z = ve.test(P.contains) || P.compareDocumentPosition ? function(e, t) {
            ...
            q = P.compareDocumentPosition ? function(e, r) {
                ...
                return i ? 1 & i || !H.sortDetached && r.compareDocumentPosition(e) === i ? e === t || z(O, e) ? -1 : r === t || z(O, r) ? 1 : A ? re.call(A, e) - re.call(A, r) : 0 : 4 & i ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            } : function(e, r) {
                var i, n = 0,
                    o = e.parentNode,
                    a = r.parentNode,
                ...
                if (!o || !a) return e === t ? -1 : r === t ? 1 : o ? -1 : a ? 1 : A ? re.call(A, e) - re.call(A, r) : 0;
                if (o === a) return s(e, r);
                i = e;
        ...
        r.matchesSelector = function(e, t) {
            ...
            t = t.replace(de, "='$1']");
            if (H.matchesSelector && F && (!U || !U.test(t)) && (!N || !N.test(t))) try {
                var i = V.call(e, t);
                if (i || H.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (n) {}
            return r(t, L, null, [e]).length > 0
        };
        ...
        r.attr = function(e, r) {
            (e.ownerDocument || e) !== L && D(e);
            var i = b.attrHandle[r.toLowerCase()],
                n = i && K.call(b.attrHandle, r.toLowerCase()) ? i(e, r, !F) : t;
        ...
        r.uniqueSort = function(e) {
            var t, r = [],
                i = 0,
                n = 0;
            X = !H.detectDuplicates;
            A = !H.sortStable && e.slice(0);
            e.sort(q);
            if (X) {
        ...
        b = r.selectors = {
            ...
            preFilter: {
                ATTR: function(e) {
                    e[1] = e[1].replace(He, we);
                    e[3] = (e[4] || e[5] || "").replace(He, we);
                    "~=" === e[2] && (e[3] = " " + e[3] + " ");
                    return e.slice(0, 4)
                },
                CHILD: function(e) {
                    ...
                    if ("nth" === e[1].slice(0, 3)) {
                        ...
                        e[5] = +(e[7] + e[8] || "odd" === e[3])
                    } else e[3] && r.error(e[0]);
                    return e
                },
                PSEUDO: function(e) {
                    var r, i = !e[5] && e[2];
                    if (ge.CHILD.test(e[0])) return null;
                    if (e[3] && e[4] !== t) e[2] = e[4];
                    else if (i && me.test(i) && (r = f(i, !0)) && (r = i.indexOf(")", i.length - r) - i.length)) {
                        e[0] = e[0].slice(0, r);
                        e[2] = i.slice(0, r)
                    }
                    return e.slice(0, 3)
            ...
            filter: {
                TAG: function(e) {
                    var t = e.replace(He, we).toLowerCase();
                    return "*" === e ? function() {
                        return !0
                    } : function(e) {
                ...
                ATTR: function(e, t, i) {
                    return function(n) {
                        ...
                        if (!t) return !0;
                        o += "";
                        return "=" === t ? o === i : "!=" === t ? o !== i : "^=" === t ? i && 0 === o.indexOf(i) : "*=" === t ? i && o.indexOf(i) > -1 : "$=" === t ? i && o.slice(-i.length) === i : "~=" === t ? (" " + o + " ").indexOf(i) > -1 : "|=" === t ? o === i || o.slice(0, i.length + 1) === i + "-" : !1
                    }
                },
                    ...
                    return 1 === i && 0 === n ? function(e) {
                        ...
                        if (E) {
                            ...
                            if (a && v) {
                                ...
                                f = c[0] === k && c[2];
                                u = p && E.childNodes[p];
                                for (; u = ++p && u && u[m] || (f = p = 0) || d.pop();)
                                    if (1 === u.nodeType && ++f && u === t) {
                                        h[e] = [k, p, f];
                                        break
                                    }
                            } else if (v && (c = (t[B] || (t[B] = {}))[e]) && c[0] === k) f = c[1];
                            else
                                for (; u = ++p && u && u[m] || (f = p = 0) || d.pop();)
                                    if ((s ? u.nodeName.toLowerCase() === g : 1 === u.nodeType) && ++f) {
                                        v && ((u[B] || (u[B] = {}))[e] = [k, f]);
                                        if (u === t) break
                                    }
                            f -= n;
                            return f === i || f % i === 0 && f / i >= 0
                        }
                    }
                },
                PSEUDO: function(e, t) {
                    ...
                    if (o.length > 1) {
                        i = [e, e, "", t];
                        return b.setFilters.hasOwnProperty(e.toLowerCase()) ? n(function(e, r) {
            ...
            pseudos: {
                ...
                lang: n(function(e) {
                    Ee.test(e || "") || r.error("unsupported lang: " + e);
                    e = e.replace(He, we).toLowerCase();
                    return function(t) {
                        var r;
                        do
        ...
        H.sortStable = B.split("").sort(q).join("") === B;
        H.detectDuplicates = X;
        D();
        ...
        oe.unique = r.uniqueSort;
        oe.text = r.getText;
        oe.isXMLDoc = r.isXML;
        oe.contains = r.contains
    }(e);
    var de = {};
    oe.Callbacks = function(e) {
        e = "string" == typeof e ? de[e] || i(e) : oe.extend({}, e);
        var r, n, o, a, s, l, c = [],
            h = !e.once && [],
            u = function(t) {
                r = e.memory && t;
                ...
                o = !1;
                c && (h ? h.length && u(h.shift()) : r ? c = [] : f.disable())
            },
            f = {
                add: function() {
                    if (c) {
                        ...
                        ! function i(t) {
                            oe.each(t, function(t, r) {
                                var n = oe.type(r);
                                "function" === n ? e.unique && f.has(r) || c.push(r) : r && r.length && "string" !== n && i(r)
                            })
                        }(arguments);
                        if (o) s = c.length;
                        else if (r) {
                ...
                remove: function() {
                    c && oe.each(arguments, function(e, t) {
                        for (var r;
                            (r = oe.inArray(t, c, r)) > -1;) {
                            c.splice(r, 1);
                            if (o) {
                                s >= r && s--;
                                l >= r && l--
                        ...
                        return oe.Deferred(function(r) {
                            oe.each(t, function(t, o) {
                                ...
                                n[o[1]](function() {
                                    ...
                                    e && oe.isFunction(e.promise) ? e.promise().done(r.resolve).fail(r.reject).progress(r.notify) : r[a + "With"](this === i ? r.promise() : this, s ? [e] : arguments)
                                })
                            });
                            e = null
                        }).promise()
        ...
        when: function(e) {
            var t, r, i, n = 0,
                ...
                c = function(e, r, i) {
                    return function(n) {
                        r[e] = this;
                        i[e] = arguments.length > 1 ? ee.call(arguments) : n;
            ...
            if (a > 1) {
                ...
                r = new Array(a);
                i = new Array(a);
                for (; a > n; n++) o[n] && oe.isFunction(o[n].promise) ? o[n].promise().done(c(n, i, o)).fail(l.reject).progress(c(n, r, t)) : --s
            }
            s || l.resolveWith(i, o);
            return l.promise()
        }
    ...
    oe.support = function(t) {
        var r = W.createElement("input"),
            i = W.createDocumentFragment(),
            n = W.createElement("div"),
            o = W.createElement("select"),
            a = o.appendChild(W.createElement("option"));
        if (!r.type) return t;
        r.type = "checkbox";
        t.checkOn = "" !== r.value;
        ...
        t.clearCloneStyle = "content-box" === n.style.backgroundClip;
        oe(function() {
            var r, i, o = "padding:0;margin:0;border:0;display:block;-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box",
            ...
            if (a) {
                ...
                a.appendChild(r).appendChild(n);
                n.innerHTML = "";
                n.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%";
                ...
                if (e.getComputedStyle) {
                    ...
                    i = n.appendChild(W.createElement("div"));
                    i.style.cssText = n.style.cssText = o;
    ...
    var me, Ee, ge = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        ve = /([A-Z])/g;
    n.uid = 1;
    n.accepts = function(e) {
    ...
    n.prototype = {
        ...
        set: function(e, t, r) {
            ...
            else if (oe.isEmptyObject(o)) oe.extend(this.cache[n], t);
            else
                for (i in t) o[i] = t[i];
            return o
        },
        ...
        access: function(e, r, i) {
            var n;
            if (r === t || r && "string" == typeof r && i === t) {
                n = this.get(e, r);
                return n !== t ? n : this.get(e, oe.camelCase(r))
            }
            this.set(e, r, i);
            return i !== t ? i : r
        },
        remove: function(e, r) {
            var i, n, o, a = this.key(e),
                s = this.cache[a];
            if (r === t) this.cache[a] = {};
            else {
                if (oe.isArray(r)) n = r.concat(r.map(oe.camelCase));
                else {
                    o = oe.camelCase(r);
                    if (r in s) n = [r, o];
                    else {
                        n = o;
                        n = n in s ? [n] : n.match(se) || []
                    }
                }
                i = n.length;
                for (; i--;) delete s[n[i]]
    ...
    oe.fn.extend({
        data: function(e, r) {
            ...
            if (e === t) {
                if (this.length) {
                    l = me.get(a);
                    if (1 === a.nodeType && !Ee.get(a, "hasDataAttrs")) {
                        i = a.attributes;
                        for (; s < i.length; s++) {
                            n = i[s].name;
                            if (0 === n.indexOf("data-")) {
            ...
            return "object" == typeof e ? this.each(function() {
                me.set(this, e)
            }) : oe.access(this, function(r) {
                var i, n = oe.camelCase(e);
                if (a && r === t) {
                    i = me.get(a, e);
                    if (i !== t) return i;
                    i = me.get(a, n);
                    ...
                    var i = me.get(this, n);
                    me.set(this, n, r); - 1 !== e.indexOf("-") && i !== t && me.set(this, e, r)
                })
    ...
    oe.extend({
        queue: function(e, t, r) {
            ...
            if (e) {
                t = (t || "fx") + "queue";
                i = Ee.get(e, t);
                r && (!i || oe.isArray(r) ? i = Ee.access(e, t, oe.makeArray(r)) : i.push(r));
                return i || []
            }
        },
        ...
        _queueHooks: function(e, t) {
            var r = t + "queueHooks";
            return Ee.get(e, r) || Ee.access(e, r, {
                empty: oe.Callbacks("once memory").add(function() {
                    Ee.remove(e, [t + "queue", r])
                })
            })
        }
    });
    oe.fn.extend({
        queue: function(e, r) {
            ...
            return arguments.length < i ? oe.queue(this[0], e) : r === t ? this : this.each(function() {
                var t = oe.queue(this, e, r);
    ...
    oe.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (l) {
                ...
                for (; s > a; a++) {
                    r = this[a];
                    i = 1 === r.nodeType && (r.className ? (" " + r.className + " ").replace(Re, " ") : " ");
                    if (i) {
                        o = 0;
                        for (; n = t[o++];) i.indexOf(" " + n + " ") < 0 && (i += n + " ");
                        r.className = oe.trim(i)
                    }
                }
            }
            return this
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === r ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(r) {
                ...
                if ("string" === r)
                    for (var t, i = 0, n = oe(this), o = e.match(se) || []; t = o[i++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                else if (r === j || "boolean" === r) {
                    this.className && Ee.set(this, "__className__", this.className);
        ...
        hasClass: function(e) {
            for (var t = " " + e + " ", r = 0, i = this.length; i > r; r++)
                if (1 === this[r].nodeType && (" " + this[r].className + " ").replace(Re, " ").indexOf(t) >= 0) return !0;
            return !1
        },
        val: function(e) {
            var r, i, n, o = this[0];
            if (arguments.length) {
                ...
                return this.each(function(i) {
                    var o;
                    if (1 === this.nodeType) {
                        o = n ? e.call(this, i, oe(this).val()) : e;
                        null == o ? o = "" : "number" == typeof o ? o += "" : oe.isArray(o) && (o = oe.map(o, function(e) {
                            return null == e ? "" : e + ""
                        }));
                        r = oe.valHooks[this.type] || oe.valHooks[this.nodeName.toLowerCase()];
                        r && "set" in r && r.set(this, o, "value") !== t || (this.value = o)
                    }
                })
            }
            if (o) {
                r = oe.valHooks[o.type] || oe.valHooks[o.nodeName.toLowerCase()];
                if (r && "get" in r && (i = r.get(o, "value")) !== t) return i;
                i = o.value;
                return "string" == typeof i ? i.replace(xe, "") : null == i ? "" : i
            }
        }
    });
    oe.extend({
            ...
            select: {
                get: function(e) {
                    for (var t, r, i = e.options, n = e.selectedIndex, o = "select-one" === e.type || 0 > n, a = o ? null : [], s = o ? n + 1 : i.length, l = 0 > n ? s : o ? n : 0; s > l; l++) {
                        r = i[l];
                        if ((r.selected || l === n) && (oe.support.optDisabled ? !r.disabled : null === r.getAttribute("disabled")) && (!r.parentNode.disabled || !oe.nodeName(r.parentNode, "optgroup"))) {
                            t = oe(r).val();
                            if (o) return t;
                            a.push(t)
                        }
                ...
                set: function(e, t) {
                    for (var r, i, n = e.options, o = oe.makeArray(t), a = n.length; a--;) {
                        i = n[a];
                        (i.selected = oe.inArray(oe(i).val(), o) >= 0) && (r = !0)
                    }
                    r || (e.selectedIndex = -1);
                    return o
                }
        ...
        attr: function(e, r, i) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a) {
                if (typeof e.getAttribute === j) return oe.prop(e, r, i);
                if (1 !== a || !oe.isXMLDoc(e)) {
                    r = r.toLowerCase();
                    n = oe.attrHooks[r] || (oe.expr.match.bool.test(r) ? Te : ye)
                }
                if (i === t) {
                    if (n && "get" in n && null !== (o = n.get(e, r))) return o;
                    o = oe.find.attr(e, r);
                    return null == o ? t : o
                }
                if (null !== i) {
                    if (n && "set" in n && (o = n.set(e, i, r)) !== t) return o;
                    e.setAttribute(r, i + "");
                    return i
                }
                oe.removeAttr(e, r)
        ...
        prop: function(e, r, i) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) {
                ...
                return i !== t ? o && "set" in o && (n = o.set(e, i, r)) !== t ? n : e[r] = i : o && "get" in o && null !== (n = o.get(e, r)) ? n : e[r]
            }
        },
        propHooks: {
            tabIndex: {
    ...
    oe.each(oe.expr.match.bool.source.match(/\w+/g), function(e, r) {
        var i = oe.expr.attrHandle[r] || oe.find.attr;
        oe.expr.attrHandle[r] = function(e, r, n) {
            var o = oe.expr.attrHandle[r],
                a = n ? t : (oe.expr.attrHandle[r] = t) != i(e, r, n) ? r.toLowerCase() : null;
            oe.expr.attrHandle[r] = o;
            return a
        }
    });
    ...
    oe.event = {
        global: {},
        add: function(e, r, i, n, o) {
            var a, s, l, c, h, u, f, p, d, m, E, g = Ee.get(e);
            if (g) {
                if (i.handler) {
                    a = i;
                    i = a.handler;
                ...
                i.guid || (i.guid = oe.guid++);
                (c = g.events) || (c = g.events = {});
                if (!(s = g.handle)) {
                    s = g.handle = function(e) {
                        return typeof oe === j || e && oe.event.triggered === e.type ? t : oe.event.dispatch.apply(s.elem, arguments)
                    };
                    s.elem = e
                }
                r = (r || "").match(se) || [""];
                ...
                for (; h--;) {
                    ...
                    if (d) {
                        ...
                        if (!(p = c[d])) {
                            p = c[d] = [];
                            p.delegateCount = 0;
                            f.setup && f.setup.call(e, n, m, s) !== !1 || e.addEventListener && e.addEventListener(d, s, !1)
                        }
                        if (f.add) {
                            f.add.call(e, u);
        ...
        remove: function(e, t, r, i, n) {
            var o, a, s, l, c, h, u, f, p, d, m, E = Ee.hasData(e) && Ee.get(e);
            if (E && (l = E.events)) {
                t = (t || "").match(se) || [""];
                c = t.length;
                for (; c--;) {
        ...
        trigger: function(r, i, n, o) {
            var a, s, l, c, h, u, f, p = [n || W],
                d = ie.call(r, "type") ? r.type : r,
                m = ie.call(r, "namespace") ? r.namespace.split(".") : [];
            s = l = n = n || W;
            if (3 !== n.nodeType && 8 !== n.nodeType && !_e.test(d + oe.event.triggered)) {
                if (d.indexOf(".") >= 0) {
                    m = d.split(".");
                    d = m.shift();
                    m.sort()
                ...
                h = d.indexOf(":") < 0 && "on" + d;
                r = r[oe.expando] ? r : new oe.Event(d, "object" == typeof r && r);
                r.isTrigger = o ? 2 : 3;
                r.namespace = m.join(".");
                r.namespace_re = r.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null;
                r.result = t;
                r.target || (r.target = n);
                i = null == i ? [r] : oe.makeArray(i, [r]);
                f = oe.event.special[d] || {};
                if (o || !f.trigger || f.trigger.apply(n, i) !== !1) {
                    if (!o && !f.noBubble && !oe.isWindow(n)) {
                        c = f.delegateType || d;
                        _e.test(c + d) || (s = s.parentNode);
                        for (; s; s = s.parentNode) {
                            p.push(s);
                            l = s
                        }
                        l === (n.ownerDocument || W) && p.push(l.defaultView || l.parentWindow || e)
                    }
                    a = 0;
                    for (;
                        (s = p[a++]) && !r.isPropagationStopped();) {
                        r.type = a > 1 ? c : f.bindType || d;
                        u = (Ee.get(s, "events") || {})[r.type] && Ee.get(s, "handle");
                        u && u.apply(s, i);
                        u = h && s[h];
                        u && oe.acceptData(s) && u.apply && u.apply(s, i) === !1 && r.preventDefault()
                    }
                    r.type = d;
                    if (!o && !r.isDefaultPrevented() && (!f._default || f._default.apply(p.pop(), i) === !1) && oe.acceptData(n) && h && oe.isFunction(n[d]) && !oe.isWindow(n)) {
                        l = n[h];
                        l && (n[h] = null);
        ...
        dispatch: function(e) {
            ...
            var r, i, n, o, a, s = [],
                ...
                h = oe.event.special[e.type] || {};
            l[0] = e;
            e.delegateTarget = this;
            if (!h.preDispatch || h.preDispatch.call(this, e) !== !1) {
                s = oe.event.handlers.call(this, e, c);
                r = 0;
                for (;
                    ...
                    i = 0;
                    for (;
                        (a = o.handlers[i++]) && !e.isImmediatePropagationStopped();)
                        if (!e.namespace_re || e.namespace_re.test(a.namespace)) {
                            e.handleObj = a;
                            e.data = a.data;
                            n = ((oe.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, l);
                            if (n !== t && (e.result = n) === !1) {
                                e.preventDefault();
                                e.stopPropagation()
                            }
                ...
                h.postDispatch && h.postDispatch.call(this, e);
                return e.result
            }
        },
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (c.disabled !== !0 || "click" !== e.type) {
                        ...
                        for (i = 0; l > i; i++) {
                            a = r[i];
                            o = a.selector + " ";
                            n[o] === t && (n[o] = a.needsContext ? oe(o, this).index(c) >= 0 : oe.find(o, this, null, [c]).length);
                            n[o] && n.push(a)
                        }
                        n.length && s.push({
                            elem: c,
        ...
        mouseHooks: {
            ...
            filter: function(e, r) {
                ...
                if (null == e.pageX && null != r.clientX) {
                    i = e.target.ownerDocument || W;
                    n = i.documentElement;
                    o = i.body;
                    e.pageX = r.clientX + (n && n.scrollLeft || o && o.scrollLeft || 0) - (n && n.clientLeft || o && o.clientLeft || 0);
                    e.pageY = r.clientY + (n && n.scrollTop || o && o.scrollTop || 0) - (n && n.clientTop || o && o.clientTop || 0)
                }
        ...
        fix: function(e) {
            ...
            var t, r, i, n = e.type,
                o = e,
                a = this.fixHooks[n];
            a || (this.fixHooks[n] = a = be.test(n) ? this.mouseHooks : we.test(n) ? this.keyHooks : {});
        ...
        simulate: function(e, t, r, i) {
            ...
            i ? oe.event.trigger(n, null, t) : oe.event.dispatch.call(t, n);
    ...
    oe.fn.extend({
        on: function(e, r, i, n, o) {
            ...
            if ("object" == typeof e) {
                ...
                for (l in e) this.on(l, r, i, e[l], o);
                return this
            }
            if (null == i && null == n) {
                n = r;
        ...
        off: function(e, r, i) {
            ...
            if (r === !1 || "function" == typeof r) {
                i = r;
                r = t
            }
            i === !1 && (i = s);
            return this.each(function() {
                oe.event.remove(this, e, i, r)
            })
        },
    ...
    oe.fn.extend({
        ...
        is: function(e) {
            return !!h(this, "string" == typeof e && Ae.test(e) ? oe(e) : e || [], !1).length
        },
        closest: function(e, t) {
            for (var r, i = 0, n = this.length, o = [], a = Ae.test(e) || "string" != typeof e ? oe(e, t || this.context) : 0; n > i; i++)
        ...
        add: function(e, t) {
            var r = "string" == typeof e ? oe(e, t) : oe.makeArray(e && e.nodeType ? [e] : e),
                i = oe.merge(this.get(), r);
    ...
    oe.fn.extend({
        text: function(e) {
            return oe.access(this, function(e) {
                return e === t ? oe.text(this) : this.empty().append((this[0] && this[0].ownerDocument || W).createTextNode(e))
        ...
        remove: function(e, t) {
            for (var r, i = e ? oe.filter(e, this) : this, n = 0; null != (r = i[n]); n++) {
                t || 1 !== r.nodeType || oe.cleanData(E(r));
                if (r.parentNode) {
                    t && oe.contains(r.ownerDocument, r) && d(E(r, "script"));
        ...
        html: function(e) {
            return oe.access(this, function(e) {
                var r = this[0] || {},
                    i = 0,
                    n = this.length;
                if (e === t && 1 === r.nodeType) return r.innerHTML;
                if ("string" == typeof e && !Ne.test(e) && !ke[(Pe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Le, "<$1></$2>");
                    try {
                        for (; n > i; i++) {
                            r = this[i] || {};
        ...
        replaceWith: function() {
            var e = oe.map(this, function(e) {
                ...
                t = 0;
            this.domManip(arguments, function(r) {
                var i = e[t++],
                    n = e[t++];
                if (n) {
                    i && i.parentNode !== n && (i = this.nextSibling);
                    oe(this).remove();
                    n.insertBefore(r, i)
                }
            }, !0);
        ...
        domManip: function(e, t, r) {
            ...
            var i, n, o, a, s, l, c = 0,
                ...
                m = e[0],
                g = oe.isFunction(m);
            if (g || !(1 >= h || "string" != typeof m || oe.support.checkClone) && Ve.test(m)) return this.each(function(i) {
                var n = u.eq(i);
                g && (e[0] = m.call(this, i, n.html()));
                n.domManip(e, t, r)
            });
            if (h) {
                i = oe.buildFragment(e, this[0].ownerDocument, !1, !r && this);
                n = i.firstChild;
                1 === i.childNodes.length && (i = n);
                if (n) {
                    o = oe.map(E(i, "script"), f);
                    a = o.length;
                    for (; h > c; c++) {
                        s = i;
                        if (c !== d) {
                            s = oe.clone(s, !0, !0);
                            a && oe.merge(o, E(s, "script"))
                        }
                        t.call(this[c], s, c)
                    }
                    if (a) {
                        ...
                        for (c = 0; a > c; c++) {
                            s = o[c];
                            ze.test(s.type || "") && !Ee.access(s, "globalEval") && oe.contains(l, s) && (s.src ? oe._evalUrl(s.src) : oe.globalEval(s.textContent.replace(Oe, "")))
                        }
                    }
                }
            }
    ...
    oe.extend({
        clone: function(e, t, r) {
            ...
            if (!(oe.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || oe.isXMLDoc(e))) {
                a = E(s);
                o = E(e);
                for (i = 0, n = o.length; n > i; i++) g(o[i], a[i])
            }
            if (t)
                if (r) {
                    o = o || E(e);
                    a = a || E(s);
                    for (i = 0, n = o.length; n > i; i++) m(o[i], a[i])
                } else m(e, s);
            a = E(s, "script");
            a.length > 0 && d(a, !l && E(e, "script"));
            return s
        },
        buildFragment: function(e, t, r, i) {
            for (var n, o, a, s, l, c, h = 0, u = e.length, f = t.createDocumentFragment(), p = []; u > h; h++) {
                n = e[h];
                if (n || 0 === n)
                    if ("object" === oe.type(n)) oe.merge(p, n.nodeType ? [n] : n);
                    else if (Fe.test(n)) {
                    o = o || f.appendChild(t.createElement("div"));
                    a = (Pe.exec(n) || ["", ""])[1].toLowerCase();
                    s = ke[a] || ke._default;
                    o.innerHTML = s[1] + n.replace(Le, "<$1></$2>") + s[2];
                    c = s[0];
                    for (; c--;) o = o.lastChild;
            ...
            h = 0;
            for (; n = p[h++];)
                if (!i || -1 === oe.inArray(n, i)) {
                    l = oe.contains(n.ownerDocument, n);
                    o = E(f.appendChild(n), "script");
                    l && d(o);
                    if (r) {
                        c = 0;
                        for (; n = o[c++];) ze.test(n.type || "") && r.push(n)
                    }
                }
            return f
        },
        cleanData: function(e) {
            for (var r, i, o, a, s, l, c = oe.event.special, h = 0;
                (i = e[h]) !== t; h++) {
                if (n.accepts(i)) {
                    s = i[Ee.expando];
                    if (s && (r = Ee.cache[s])) {
                        o = Object.keys(r.events || {});
                        if (o.length)
                            for (l = 0;
                                (a = o[l]) !== t; l++) c[a] ? oe.event.remove(i, a) : oe.removeEvent(i, a, r.handle);
                        Ee.cache[s] && delete Ee.cache[s]
                    }
                }
    ...
    var Ie, je, Ge = /^(none|table(?!-c[ea]).+)/,
        We = /^margin/,
        Xe = new RegExp("^(" + ae + ")(.*)$", "i"),
        qe = new RegExp("^(" + ae + ")(?!px)[a-z%]+$", "i"),
        Ye = new RegExp("^([+-])=(" + ae + ")", "i"),
        $e = {
            BODY: "block"
        },
    ...
    oe.fn.extend({
        css: function(e, r) {
            return oe.access(this, function(e, r, i) {
                var n, o, a = {},
                    s = 0;
                if (oe.isArray(r)) {
                    n = T(e);
                    o = r.length;
                    for (; o > s; s++) a[r[s]] = oe.css(e, r[s], !1, n);
                    return a
                }
                return i !== t ? oe.style(e, r, i) : oe.css(e, r)
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                y(this) ? oe(this).show() : oe(this).hide()
            })
        }
    });
    oe.extend({
        ...
        style: function(e, r, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, a, s, l = oe.camelCase(r),
                    c = e.style;
                r = oe.cssProps[l] || (oe.cssProps[l] = v(c, l));
                s = oe.cssHooks[r] || oe.cssHooks[l];
                if (i === t) return s && "get" in s && (o = s.get(e, !1, n)) !== t ? o : c[r];
                a = typeof i;
                if ("string" === a && (o = Ye.exec(i))) {
                    i = (o[1] + 1) * o[2] + parseFloat(oe.css(e, r));
                    a = "number"
                }
                if (!(null == i || "number" === a && isNaN(i))) {
                    "number" !== a || oe.cssNumber[l] || (i += "px");
                    oe.support.clearCloneStyle || "" !== i || 0 !== r.indexOf("background") || (c[r] = "inherit");
                    s && "set" in s && (i = s.set(e, i, n)) === t || (c[r] = i)
                }
            }
        },
        css: function(e, r, i, n) {
            var o, a, s, l = oe.camelCase(r);
            r = oe.cssProps[l] || (oe.cssProps[l] = v(e.style, l));
            s = oe.cssHooks[r] || oe.cssHooks[l];
            s && "get" in s && (o = s.get(e, !0, i));
            o === t && (o = Ie(e, r, n));
            "normal" === o && r in Qe && (o = Qe[r]);
            if ("" === i || i) {
                a = parseFloat(o);
                return i === !0 || oe.isNumeric(a) ? a || 0 : o
            }
            return o
        }
    });
    Ie = function(e, r, i) {
        var n, o, a, s = i || T(e),
            l = s ? s.getPropertyValue(r) || s[r] : t,
            c = e.style;
        if (s) {
            "" !== l || oe.contains(e.ownerDocument, e) || (l = oe.style(e, r));
            if (qe.test(l) && We.test(r)) {
                n = c.width;
                o = c.minWidth;
                a = c.maxWidth;
    ...
    oe.each(["height", "width"], function(e, t) {
        oe.cssHooks[t] = {
            get: function(e, r, i) {
                return r ? 0 === e.offsetWidth && Ge.test(oe.css(e, "display")) ? oe.swap(e, Ke, function() {
                    return w(e, t, i)
                }) : w(e, t, i) : void 0
            },
            set: function(e, r, i) {
                var n = i && T(e);
                return x(e, r, i ? H(e, t, i, oe.support.boxSizing && "border-box" === oe.css(e, "boxSizing", !1, n), n) : 0)
            }
        }
    });
    oe(function() {
        ...
        !oe.support.pixelPosition && oe.fn.position && oe.each(["top", "left"], function(e, t) {
            oe.cssHooks[t] = {
                get: function(e, r) {
                    if (r) {
                        r = Ie(e, t);
                        return qe.test(r) ? oe(e).position()[t] + "px" : r
                    }
                }
            }
        })
    ...
    oe.each({
        ...
        oe.cssHooks[e + t] = {
            expand: function(r) {
                for (var i = 0, n = {}, o = "string" == typeof r ? r.split(" ") : [r]; 4 > i; i++) n[e + Ze[i] + t] = o[i] || o[i - 2] || o[0];
                return n
            }
        };
        We.test(e) || (oe.cssHooks[e + t].set = x)
    });
    var et = /%20/g,
        tt = /\[\]$/,
        rt = /\r?\n/g,
    ...
    oe.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && nt.test(this.nodeName) && !it.test(e) && (this.checked || !Ue.test(e))
            }).map(function(e, t) {
                var r = oe(this).val();
    ...
    try {
        ...
        at = W.createElement("a");
        at.href = "";
        at = at.href
    }
    ot = mt.exec(at.toLowerCase()) || [];
    oe.fn.load = function(e, r, i) {
    ...
    oe.extend({
        ...
        ajax: function(e, r) {
            function i(e, r, i, s) {
                ...
                if (2 !== T) {
                    ...
                    if (c) {
                        ...
                        if (204 === e || "HEAD" === f.type) H = "nocontent";
                        else if (304 === e) H = "notmodified";
                        else {
                            H = y.state;
                            u = y.data;
                            v = y.error;
                    ...
                    x.status = e;
                    x.statusText = (r || H) + "";
                    c ? m.resolveWith(p, [u, H, x]) : m.rejectWith(p, [x, H, v]);
                    x.statusCode(g);
                    g = t;
                ...
                x = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === T) {
                            if (!s) {
                                s = {};
                                for (; t = ut.exec(a);) s[t[1].toLowerCase()] = t[2]
                            }
                            t = s[e.toLowerCase()]
                        }
            ...
            x.success = x.done;
            x.error = x.fail;
            f.url = ((e || f.url || at) + "").replace(ct, "").replace(dt, ot[1] + "//");
            f.type = r.method || r.type || f.method || f.type;
            f.dataTypes = oe.trim(f.dataType || "*").toLowerCase().match(se) || [""];
            if (null == f.crossDomain) {
                c = mt.exec(f.url.toLowerCase());
                f.crossDomain = !(!c || c[1] === ot[1] && c[2] === ot[2] && (c[3] || ("http:" === c[1] ? "80" : "443")) === (ot[3] || ("http:" === ot[1] ? "80" : "443")))
            }
            ...
            if (!f.hasContent) {
                ...
                f.cache === !1 && (f.url = ht.test(o) ? o.replace(ht, "$1_=" + st++) : o + (lt.test(o) ? "&" : "?") + "_=" + st++)
            }
            if (f.ifModified) {
            ...
            x.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + yt + "; q=0.01" : "") : f.accepts["*"]);
        ...
        getScript: function(e, r) {
            return oe.get(e, t, r, "script")
        }
    });
    oe.each(["get", "post"], function(e, r) {
        oe[r] = function(e, i, n, o) {
            if (oe.isFunction(i)) {
                o = o || n;
                n = i;
                i = t
    ...
    oe.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Rt.pop() || oe.expando + "_" + st++;
            this[e] = !0;
            return e
        }
    });
    oe.ajaxPrefilter("json jsonp", function(r, i, n) {
        var o, a, s, l = r.jsonp !== !1 && (xt.test(r.url) ? "url" : "string" == typeof r.data && !(r.contentType || "").indexOf("application/x-www-form-urlencoded") && xt.test(r.data) && "data");
        if (l || "jsonp" === r.dataTypes[0]) {
            o = r.jsonpCallback = oe.isFunction(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback;
            l ? r[l] = r[l].replace(xt, "$1" + o) : r.jsonp !== !1 && (r.url += (lt.test(r.url) ? "&" : "?") + r.jsonp + "=" + o);
            ...
            n.always(function() {
                e[o] = a;
                if (r[o]) {
                    r.jsonpCallback = i.jsonpCallback;
                    Rt.push(o)
                }
    ...
    oe.support.cors = !!Ht && "withCredentials" in Ht;
    oe.support.ajax = Ht = !!Ht;
    oe.ajaxTransport(function(e) {
        var r;
        return oe.support.cors || Ht && !e.crossDomain ? {
            send: function(i, n) {
                var o, a, s = e.xhr();
                ...
                r = function(e) {
                    return function() {
                        if (r) {
                            delete _t[a];
                            r = s.onload = s.onerror = null;
                            "abort" === e ? s.abort() : "error" === e ? n(s.status || 404, s.statusText) : n(wt[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                                text: s.responseText
    ...
    var St, Mt, Ct = /^(?:toggle|show|hide)$/,
        At = new RegExp("^(?:([+-])=|)(" + ae + ")([a-z%]*)$", "i"),
        Dt = /queueHooks$/,
        Lt = [V],
        Pt = {
            "*": [function(e, t) {
                var r = this.createTween(e, t),
                    i = r.cur(),
                    n = At.exec(t),
                    o = n && n[3] || (oe.cssNumber[e] ? "" : "px"),
                    a = (oe.cssNumber[e] || "px" !== o && +i) && At.exec(oe.css(r.elem, e)),
                    s = 1,
                    l = 20;
                if (a && a[3] !== o) {
                    o = o || a[3];
    ...
    z.prototype = {
        ...
        run: function(e) {
            ...
            r && r.set ? r.set(this) : z.propHooks._default.set(this);
            return this
        }
    };
        ...
        stop: function(e, r, i) {
            ...
            return this.each(function() {
                ...
                if (r) a[r] && a[r].stop && n(a[r]);
                    ...
                    for (r in a) a[r] && a[r].stop && Dt.test(r) && n(a[r]);
                for (r = o.length; r--;)
    ...
    oe.fn.offset = function(e) {
        ...
        if (a) {
            r = a.documentElement;
            if (!oe.contains(r, n)) return o;
            typeof n.getBoundingClientRect !== j && (o = n.getBoundingClientRect());
            i = O(a);
            return {
                top: o.top + i.pageYOffset - r.clientTop,
                left: o.left + i.pageXOffset - r.clientLeft
            }
        }
    };
    oe.offset = {
        setOffset: function(e, t, r) {
            ...
            oe.isFunction(t) && (t = t.call(e, r, s));
    ...
    oe.each({
        ...
        var n = "pageYOffset" === i;
        oe.fn[r] = function(o) {
            return oe.access(this, function(r, o, a) {
                var s = O(r);
                if (a === t) return s ? s[i] : r[o];
                s ? s.scrollTo(n ? e.pageXOffset : a, n ? a : e.pageYOffset) : r[o] = a;
                return void 0
    ...
    oe.each({
        ...
        oe.each({
            ...
            oe.fn[n] = function(n, o) {
                ...
                return oe.access(this, function(r, i, n) {
                    var o;
                    if (oe.isWindow(r)) return r.document.documentElement["client" + e];
                    if (9 === r.nodeType) {
                        o = r.documentElement;
                        return Math.max(r.body["scroll" + e], o["scroll" + e], r.body["offset" + e], o["offset" + e], o["client" + e])
                    }
                    return n === t ? oe.css(r, i, s) : oe.style(r, i, n, s)
                }, r, a ? n : t, a, null)
            }
        })
    });
...
(function() {
    ...
    if ("undefined" != typeof exports) {
        "undefined" != typeof module && module.exports && (exports = module.exports = H);
        exports._ = H
    } else e._ = H;
    H.VERSION = "1.5.2";
    var w = H.each = H.forEach = function(e, t, i) {
        if (null != e)
            ...
            for (var a = H.keys(e), n = 0, o = a.length; o > n; n++)
                if (t.call(i, e[a[n]], a[n], e) === r) return
    };
    H.map = H.collect = function(e, t, r) {
        var i = [];
        if (null == e) return i;
    ...
    H.reduce = H.foldl = H.inject = function(e, t, r, i) {
    ...
    H.reduceRight = H.foldr = function(e, t, r, i) {
        var n = arguments.length > 2;
        null == e && (e = []);
    ...
    H.find = H.detect = function(e, t, r) {
        var i;
        _(e, function(e, n, o) {
            if (t.call(r, e, n, o)) {
                i = e;
    ...
    H.filter = H.select = function(e, t, r) {
        var i = [];
        if (null == e) return i;
    ...
    H.reject = function(e, t, r) {
        return H.filter(e, function(e, i, n) {
    ...
    var _ = H.some = H.any = function(e, t, i) {
        t || (t = H.identity);
        var n = !1;
        if (null == e) return n;
    ...
    H.where = function(e, t, r) {
        return H.isEmpty(t) ? r ? void 0 : [] : H[r ? "find" : "filter"](e, function(e) {
            for (var r in t)
                if (t[r] !== e[r]) return !1;
            return !0
        })
    ...
    H.min = function(e, t, r) {
        if (!t && H.isArray(e) && e[0] === +e[0] && e.length < 65535) return Math.min.apply(Math, e);
        if (!t && H.isEmpty(e)) return 1 / 0;
        var i = {
            computed: 1 / 0,
            value: 1 / 0
    ...
    H.sample = function(e, t, r) {
        return arguments.length < 2 || r ? e[H.random(e.length - 1)] : H.shuffle(e).slice(0, Math.max(0, t))
    };
    var S = function(e) {
        return H.isFunction(e) ? e : function(t) {
            return t[e]
        }
    };
    H.sortBy = function(e, t, r) {
        var i = S(t);
        return H.pluck(H.map(e, function(e, t, n) {
            return {
                value: e,
                index: t,
    ...
    H.groupBy = M(function(e, t, r) {
        (H.has(e, t) ? e[t] : e[t] = []).push(r)
    });
    H.indexBy = M(function(e, t, r) {
        e[t] = r
    });
    H.countBy = M(function(e, t) {
        H.has(e, t) ? e[t]++ : e[t] = 1
    });
    H.sortedIndex = function(e, t, r, i) {
        r = null == r ? H.identity : S(r);
    ...
    var C = function(e, t, r) {
        ...
        w(e, function(e) {
            H.isArray(e) || H.isArguments(e) ? t ? a.apply(r, e) : C(e, t, r) : r.push(e)
        });
        return r
    };
    ...
    H.uniq = H.unique = function(e, t, r, i) {
        if (H.isFunction(t)) {
            i = r;
            r = t;
            t = !1
        }
        var n = r ? H.map(e, r, i) : e,
            o = [],
            a = [];
        w(n, function(r, i) {
            if (t ? !i || a[a.length - 1] !== r : !H.contains(a, r)) {
                a.push(r);
                o.push(e[i])
            }
        });
    ...
    H.intersection = function(e) {
        ...
        return H.filter(H.uniq(e), function(e) {
            return H.every(t, function(t) {
                return H.indexOf(t, e) >= 0
            })
        })
    };
    ...
    H.zip = function() {
        for (var e = H.max(H.pluck(arguments, "length").concat(0)), t = new Array(e), r = 0; e > r; r++) t[r] = H.pluck(arguments, "" + r);
        return t
    };
    ...
    H.memoize = function(e, t) {
        ...
        return function() {
            ...
            return H.has(r, i) ? r[i] : r[i] = e.apply(this, arguments)
        }
    };
    ...
    H.keys = R || function(e) {
        ...
        var t = [];
        for (var r in e) H.has(e, r) && t.push(r);
        return t
    };
    H.values = function(e) {
        for (var t = H.keys(e), r = t.length, i = new Array(r), n = 0; r > n; n++) i[n] = e[t[n]];
        return i
    };
    H.pairs = function(e) {
        for (var t = H.keys(e), r = t.length, i = new Array(r), n = 0; r > n; n++) i[n] = [t[n], e[t[n]]];
        return i
    };
    H.invert = function(e) {
        for (var t = {}, r = H.keys(e), i = 0, n = r.length; n > i; i++) t[e[r[i]]] = r[i];
        return t
    };
    H.functions = H.methods = function(e) {
        var t = [];
        for (var r in e) H.isFunction(e[r]) && t.push(r);
        return t.sort()
    };
    H.extend = function(e) {
        w(s.call(arguments, 1), function(t) {
            if (t)
    ...
    H.omit = function(e) {
        var t = {},
            r = l.apply(i, s.call(arguments, 1));
        for (var n in e) H.contains(r, n) || (t[n] = e[n]);
        return t
    };
    ...
    var D = function(e, t, r, i) {
        ...
        var a = e.constructor,
            s = t.constructor;
        if (a !== s && !(H.isFunction(a) && a instanceof a && H.isFunction(s) && s instanceof s)) return !1;
        r.push(e);
        i.push(t);
        var l = 0,
            h = !0;
        if ("[object Array]" == n) {
            ...
            h = l == t.length;
            if (h)
                for (; l-- && (h = D(e[l], t[l], r, i)););
        } else {
            for (var u in e)
                if (H.has(e, u)) {
                    l++;
                    if (!(h = H.has(t, u) && D(e[u], t[u], r, i))) break
                }
            if (h) {
                for (u in t)
                    if (H.has(t, u) && !l--) break;
                h = !l
            }
        }
        r.pop();
    ...
    H.isEmpty = function(e) {
        if (null == e) return !0;
        if (H.isArray(e) || H.isString(e)) return 0 === e.length;
        for (var t in e)
    ...
    L.unescape = H.invert(L.escape);
    var P = {
        escape: new RegExp("[" + H.keys(L.escape).join("") + "]", "g"),
        unescape: new RegExp("(" + H.keys(L.unescape).join("|") + ")", "g")
    };
    ...
    H.result = function(e, t) {
        ...
        var r = e[t];
        return H.isFunction(r) ? r.call(e) : r
    };
    H.mixin = function(e) {
        w(H.functions(e), function(t) {
            var r = H[t] = e[t];
            H.prototype[t] = function() {
                var e = [this._wrapped];
                a.apply(e, arguments);
                return z.call(this, r.apply(H, e))
            }
        })
    };
    var F = 0;
    ...
    H.mixin(H);
    w(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(e) {
        var t = i[e];
...
! function(e, t, r, i, n, o, a) {
    ...
    o = t.createElement(r), a = t.getElementsByTagName(r)[0];
    o.async = 1;
    o.src = i;
...
THREE.Vector4.prototype = {
    ...
    setAxisAngleFromRotationMatrix: function(e) {
        ...
        var H = Math.sqrt((m - p) * (m - p) + (h - d) * (h - d) + (u - c) * (u - c));
        Math.abs(H) < .001 && (H = 1);
        this.x = (m - p) / H;
        this.y = (h - d) / H;
        this.z = (u - c) / H;
...
THREE.Matrix4.prototype = {
    ...
    multiplyMatrices: function(e, t) {
        ...
        n[4] = o * x + a * _ + s * A + l * F;
        n[8] = o * H + a * S + s * D + l * N;
        n[12] = o * w + a * M + s * L + l * U;
        n[1] = c * R + h * b + u * C + f * P;
        n[5] = c * x + h * _ + u * A + f * F;
        n[9] = c * H + h * S + u * D + f * N;
        n[13] = c * w + h * M + u * L + f * U;
        n[2] = p * R + d * b + m * C + E * P;
        n[6] = p * x + d * _ + m * A + E * F;
        n[10] = p * H + d * S + m * D + E * N;
        n[14] = p * w + d * M + m * L + E * U;
        n[3] = g * R + v * b + y * C + T * P;
        n[7] = g * x + v * _ + y * A + T * F;
        n[11] = g * H + v * S + y * D + T * N;
        n[15] = g * w + v * M + y * L + T * U;
        return this
    },
        ...
        l = function(s, c, h) {
            if (s instanceof e.Particle) {
                ...
                for (var x = 0, H = E.faces.length; H > x; x++) {
                    var w = E.faces[x],
                        b = v === !0 ? y[w.materialIndex] : s.material;
                    if (void 0 !== b) {
                        ...
                        if (!(Math.abs(_) < R || 0 > _)) {
                            ...
                            if (!(_ < c.near || _ > c.far)) {
                                n = r.at(_, n);
                                if (w instanceof e.Face3) {
                                    f = g[w.a];
                                    p = g[w.b];
                                    d = g[w.c];
                                    if (!e.Triangle.containsPoint(n, f, p, d)) continue
                                } else {
                                    if (!(w instanceof e.Face4)) throw Error("face type not supported");
                                    f = g[w.a];
                                    p = g[w.b];
                                    d = g[w.c];
                                    m = g[w.d];
    ...
    var Y = function(t, r) {
        ...
        var i = function(t) {
            for (var r = 0, n = t.children.length; n > r; r++) {
                var o = t.children[r];
                if (o.visible !== !1) {
                    if (o instanceof THREE.Light) L.lights.push(o);
        ...
        i(t);
        r === !0 && L.objects.sort(a);
        return L
    };
    this.projectScene = function(e, l, c, T) {
        var R, H, w, b, _, S, M, C, A, D, P, $, K, Q, Z, J, ee, te, re, ie, ne, oe, ae, se, le, ce, he = !1;
        p = 0;
        d = 0;
        E = 0;
        v = 0;
        ...
        W.setFromMatrix(O);
        L = Y(e, c);
        for (R = 0, H = L.objects.length; H > R; R++) {
            K = L.objects[R].object;
            y = K.matrixWorld;
            u = 0;
            if (K instanceof THREE.Mesh) {
                ...
                for (w = 0, b = Z.length; b > w; w++) {
                    h = t();
                    h.positionWorld.copy(Z[w]).applyMatrix4(y);
                ...
                for (w = 1, b = Z.length; b > w; w++) {
                    ne = t();
                    ne.positionScreen.copy(Z[w]).applyMatrix4(k);
                    if (!((w + 1) % me > 0)) {
                        oe = x[u - 2];
                        ...
                        if (s(X, q) === !0) {
                            ...
                            if (K.material.vertexColors === THREE.VertexColors) {
                                m.vertexColors[0].copy(K.geometry.colors[w]);
                                m.vertexColors[1].copy(K.geometry.colors[w - 1])
                            }
                            L.elements.push(m)
                        }
                    }
        ...
        for (R = 0, H = L.sprites.length; H > R; R++) {
            K = L.sprites[R].object;
            y = K.matrixWorld;
...
THREE.Geometry.prototype = {
    ...
    computeTangents: function() {
        function e(e, t, r, i, n, o, a) {
            ...
            w = d.y - f.y;
            b = 1 / (R * w - x * H);
            D.set((w * m - H * E) * b, (w * g - H * v) * b, (w * y - H * T) * b);
            L.set((R * E - x * m) * b, (R * v - x * g) * b, (R * T - x * y) * b);
            C[t].add(D);
            C[r].add(D);
            C[i].add(D);
            A[t].add(L);
        ...
        var t, r, i, n, o, a, s, l, c, h, u, f, p, d, m, E, g, v, y, T, R, x, H, w, b, _, S, M, C = [],
            A = [],
            D = new THREE.Vector3,
            L = new THREE.Vector3,
            P = new THREE.Vector3,
...
THREE.BufferGeometry.prototype = {
    ...
    computeTangents: function() {
        function e(e, t, r) {
            ...
            U = _ - x;
            V = 1 / (P * U - F * N);
            W.set((U * S - N * M) * V, (U * C - N * A) * V, (U * D - N * L) * V);
            X.set((P * M - F * S) * V, (P * A - F * C) * V, (P * L - F * D) * V);
            c[e].add(W);
            c[t].add(W);
            c[r].add(W);
            h[e].add(X);
        ...
        if (void 0 !== this.attributes.index && void 0 !== this.attributes.position && void 0 !== this.attributes.normal && void 0 !== this.attributes.uv) {
            ...
            var f, p, d, m, E, g, v, y, T, R, x, H, w, b, _, S, M, C, A, D, L, P, F, N, U, V, z, B, O, k, I, j, G, W = new THREE.Vector3,
                X = new THREE.Vector3,
                q = this.offsets;
...
THREE.JSONLoader.prototype.parse = function(e, t) {
    function r(t) {
        ...
        var i, n, a, s, l, c, h, u, f, p, d, m, E, g, v, y, T, R, x, H, w, b, _, S, M, C, A, D = e.faces,
            L = e.vertices,
            P = e.normals,
            F = e.colors,
            N = 0;
...
THREE.SceneLoader.prototype.parse = function(e, t, r) {
            ...
            if (void 0 === _.objects[u]) {
                ...
                if (f.type && f.type in S.hierarchyHandlerMap) {
                    if (void 0 === f.loading) {
                        ...
                        f.loading = !0;
                        var H = S.hierarchyHandlerMap[f.type].loaderObject;
                        H.options ? H.load(i(f.url, A.urlBaseType), c(u, e, d, f)) : H.load(i(f.url, A.urlBaseType), c(u, e, d, f), v)
                    }
                    ...
                    if (p) {
                        var w = !1;
                        d = _.materials[f.material];
                        w = d instanceof THREE.ShaderMaterial;
                        a = f.position;
                        s = f.rotation;
                        l = f.scale;
                        r = f.matrix;
                        ...
                        if (d instanceof THREE.MeshFaceMaterial)
                            for (var b = 0; b < d.materials.length; b++) w = w || d.materials[b] instanceof THREE.ShaderMaterial;
                        w && p.computeTangents();
    ...
    var p, d, m, E, g, v, y, T, R, x, H, w, b, _, S = this,
        M = THREE.Loader.prototype.extractUrlBase(r),
        C = [],
        A = e;
    for (var D in this.geometryHandlerMap) {
        var L = this.geometryHandlerMap[D].loaderClass;
        this.geometryHandlerMap[D].loaderObject = new L
    }
    for (var D in this.hierarchyHandlerMap) {
        var L = this.hierarchyHandlerMap[D].loaderClass;
        this.hierarchyHandlerMap[D].loaderObject = new L
    }
    x = 0;
    H = 0;
    _ = {
...
THREE.CanvasRenderer = function(e) {
    ...
    e = e || {};
    var h, u, f, p, d, m, E, g, v, y, T, R, x, H, w, b, _, S, M, C, A, D, L, P, F, N, U, V, z, B, O, k, I, j, G, W, X, q, Y, $ = this,
    ...
    this.setSize = function(e, t, r) {
        ...
        He.set(new THREE.Vector2(-m, -E), new THREE.Vector2(m, E));
        te = 1;
        re = 0;
        ie = null;
        ne = null;
    ...
    this.clear = function() {
        ...
        if (He.empty() === !1) {
            He.intersect(xe);
            He.expandByScalar(2);
            1 > ee && Z.clearRect(0 | He.min.x, 0 | He.min.y, He.max.x - He.min.x | 0, He.max.y - He.min.y | 0);
            if (ee > 0) {
                r(THREE.NormalBlending);
                t(1);
                s("rgba(" + Math.floor(255 * J.r) + "," + Math.floor(255 * J.g) + "," + Math.floor(255 * J.b) + "," + ee + ")");
                Z.fillRect(0 | He.min.x, 0 | He.min.y, He.max.x - He.min.x | 0, He.max.y - He.min.y | 0)
            }
            He.makeEmpty()
        }
    };
    this.render = function(e, p) {
        ...
        function J(e, i, n) {
            ...
            if (n instanceof THREE.ParticleBasicMaterial)
                if (null === n.map) {
                    ...
                    c *= i.scale.x * m;
                    h *= i.scale.y * E;
                    we.min.set(e.x - c, e.y - h);
                    we.max.set(e.x + c, e.y + h);
                    if (xe.isIntersectionBox(we) === !1) {
                        we.makeEmpty();
                        return
                    }
                    s(n.color.getStyle());
                    ...
                    o = c * f;
                    l = h * p;
                    we.min.set(e.x - o, e.y - l);
                    we.max.set(e.x + o, e.y + l);
                    if (xe.isIntersectionBox(we) === !1) {
                        we.makeEmpty();
                        return
                    }
        ...
        function ee(e, s, c, h) {
            ...
            if (h instanceof THREE.LineBasicMaterial) {
                ...
                Z.stroke();
                we.expandByScalar(2 * h.linewidth)
            ...
            if ((h instanceof THREE.MeshLambertMaterial || h instanceof THREE.MeshPhongMaterial) && null === h.map) {
                ...
                if (null !== h.map) {
                    if (h.map.mapping instanceof THREE.UVMapping) {
                        U = l.uvs[0];
                        se(R, x, H, w, b, _, U[o].x, U[o].y, U[a].x, U[a].y, U[s].x, U[s].y, h.map)
                    }
                ...
                if (h.envMap.mapping instanceof THREE.SphericalReflectionMapping) {
                    ...
                    k = .5 * Me.x + .5;
                    I = .5 * Me.y + .5;
                    se(R, x, H, w, b, _, V, z, B, O, k, I, h.envMap)
                }
            } else {
                fe.copy(h.color);
            ...
            if (void 0 !== h.map && null !== h.map || void 0 !== h.envMap && null !== h.envMap) {
                ...
                if (h instanceof THREE.MeshLambertMaterial || h instanceof THREE.MeshPhongMaterial) {
                    ...
                    if (h.wireframe === !1 && h.shading == THREE.SmoothShading && 4 == l.vertexNormalsLength) {
                        ...
                        N = ce(pe, de, me, Ee);
                        ie(R, x, H, w, S, M);
                        le(R, x, H, w, S, M, 0, 0, 1, 0, 0, 1, N);
                        ie(C, A, b, _, D, L);
                        le(C, A, b, _, D, L, 1, 0, 1, 1, 0, 1, N)
                    } else {
                        fe.copy(be);
                        Q(l.centroidModel, l.normalModel, fe);
                        fe.multiply(ge).add(ve);
        ...
        function se(e, t, r, i, n, o, a, l, c, h, u, f, p) {
            if (!(p instanceof THREE.DataTexture || void 0 === p.image || 0 == p.image.width)) {
                ...
                var E, g, v, y, T, R, x, H, w = p.offset.x / p.repeat.x,
                ...
                if (0 !== x) {
                    ...
                    var A = Re[p.id],
                        D = 4 * (Math.floor(a) + Math.floor(l) * p.image.width);
                    fe.setRGB(A[D] / 255, A[D + 1] / 255, A[D + 2] / 255);
                    ae(fe)
                }
            }
        }
        ...
        if (p instanceof THREE.Camera != !1) {
            ...
            f = h.lights;
            d();
            for (var Ae = 0, De = u.length; De > Ae; Ae++) {
                var Le = u[Ae],
                    Pe = Le.material;
                if (void 0 !== Pe && Pe.visible !== !1) {
                    we.makeEmpty();
                    if (Le instanceof THREE.RenderableParticle) {
                        g = Le;
                        g.x *= m;
                        g.y *= E;
                        J(g, Le, Pe)
                    } else if (Le instanceof THREE.RenderableLine) {
                        g = Le.v1;
                        v = Le.v2;
                        ...
                        we.setFromPoints([g.positionScreen, v.positionScreen]);
                        xe.isIntersectionBox(we) === !0 && ee(g, v, Le, Pe)
                    } else if (Le instanceof THREE.RenderableFace3) {
                        g = Le.v1;
                        v = Le.v2;
                        y = Le.v3;
                        ...
                        we.setFromPoints([g.positionScreen, v.positionScreen, y.positionScreen]);
                        xe.isIntersectionBox(we) === !0 && te(g, v, y, 0, 1, 2, Le, Pe)
                    } else if (Le instanceof THREE.RenderableFace4) {
                        g = Le.v1;
                        v = Le.v2;
                        y = Le.v3;
                        T = Le.v4;
                        ...
                        we.setFromPoints([g.positionScreen, v.positionScreen, y.positionScreen, T.positionScreen]);
                        xe.isIntersectionBox(we) === !0 && re(g, v, y, T, he, ue, Le, Pe)
                    }
                    He.union(we)
                }
            }
...
THREE.WebGLRenderer = function(e) {
    ...
    function y(e, t) {
        ...
        if (_) {
            ...
            ze.bufferData(ze.ARRAY_BUFFER, H, t)
        }
        if (S)
    ...
    function T(e, t, r, i, n) {
        if (e.__inittedArrays) {
            var o, a, s, l, c, h, u, f, E, g, v, y, T, R, x, H, w, b, _, S, M, C, A, D, L, P, F, N, U, V, z, B, O, k, I, j, G, W, X, q, Y, $, K, Q, Z, J, ee, te, re = p(n),
                ie = d(n),
                ne = m(n),
                ...
                De = e.__lineArray,
                Le = t.geometry,
                Pe = Le.verticesNeedUpdate,
                Fe = Le.elementsNeedUpdate,
                Ne = Le.uvsNeedUpdate,
                Ue = Le.normalsNeedUpdate,
                Ve = Le.tangentsNeedUpdate,
                Be = Le.colorsNeedUpdate,
                Oe = Le.morphTargetsNeedUpdate,
                ke = Le.vertices,
                Ie = e.faces3,
                je = e.faces4,
                Ge = Le.faces,
                We = Le.faceVertexUvs[0],
                Xe = Le.faceVertexUvs[1],
                qe = (Le.colors, Le.skinIndices),
                Ye = Le.skinWeights,
                $e = Le.morphTargets,
                Ke = Le.morphNormals;
            if (Pe) {
            ...
            if (Fe) {
                ...
                ze.bufferData(ze.ELEMENT_ARRAY_BUFFER, De, r)
            }
            if (Ce)
    ...
    function oe(e, t) {
        ...
        for (r = 3 * D, i = Math.max(T.length, 3 * N); i > r; r++) T[r] = 0;
        for (r = 3 * L, i = Math.max(_.length, 3 * U); i > r; r++) _[r] = 0;
        for (r = 3 * L, i = Math.max(S.length, 3 * U); i > r; r++) S[r] = 0;
    ...
    function ce(e, t, r, i, n, o, a) {
        ...
        for (H = 0; H < a.maxMorphTargets; H++) T.push("morphTarget" + H);
        for (H = 0; H < a.maxMorphNormals; H++) T.push("morphNormal" + H);
        for (x in n) T.push(x);
        ue(h, T);
        h.id = We++;
        Ge.push({
    ...
    function me(e, t, r) {
        if (r) {
            ze.texParameteri(e, ze.TEXTURE_WRAP_S, He(t.wrapS));
            ze.texParameteri(e, ze.TEXTURE_WRAP_T, He(t.wrapT));
            ze.texParameteri(e, ze.TEXTURE_MAG_FILTER, He(t.magFilter));
            ze.texParameteri(e, ze.TEXTURE_MIN_FILTER, He(t.minFilter))
        } else {
    ...
    var bt = ze.getParameter(ze.MAX_TEXTURE_IMAGE_UNITS),
        ...
        Ct = _t > 0,
        At = Ct && Be,
        Dt = (Ie ? ze.getParameter(ze.COMPRESSED_TEXTURE_FORMATS) : [], ze.getShaderPrecisionFormat(ze.VERTEX_SHADER, ze.HIGH_FLOAT)),
        Lt = ze.getShaderPrecisionFormat(ze.VERTEX_SHADER, ze.MEDIUM_FLOAT),
        ...
        Nt = (ze.getShaderPrecisionFormat(ze.FRAGMENT_SHADER, ze.LOW_FLOAT), ze.getShaderPrecisionFormat(ze.VERTEX_SHADER, ze.HIGH_INT), ze.getShaderPrecisionFormat(ze.VERTEX_SHADER, ze.MEDIUM_INT), ze.getShaderPrecisionFormat(ze.VERTEX_SHADER, ze.LOW_INT), ze.getShaderPrecisionFormat(ze.FRAGMENT_SHADER, ze.HIGH_INT), ze.getShaderPrecisionFormat(ze.FRAGMENT_SHADER, ze.MEDIUM_INT), ze.getShaderPrecisionFormat(ze.FRAGMENT_SHADER, ze.LOW_INT), Dt.precision > 0 && Pt.precision > 0),
        Ut = Lt.precision > 0 && Ft.precision > 0;
    if ("highp" === Ae && !Nt)
        if (Ut) {
            Ae = "mediump";
    ...
    this.renderBuffer = function(e, t, r, i, n, o) {
        if (i.visible !== !1) {
            ...
            } else o.morphTargetBase && w(i, n, o);
            if (f) {
    ...
    this.setBlending = function(e, t, r, i) {
        ...
        if (e === THREE.CustomBlending) {
            if (t !== rt) {
                ze.blendEquation(He(t));
                rt = t
            }
            if (r !== it || i !== nt) {
                ze.blendFunc(He(r), He(i));
                it = r;
                nt = i
            }
        } else {
...
THREE.GeometryUtils = {
    merge: function(e, t, r) {
        ...
        for (p = 0, d = f.length; d > p; p++) {
            for (var b = f[p], _ = [], H = 0, w = b.length; w > H; H++) _.push(new THREE.Vector2(b[H].x, b[H].y));
            u.push(_)
        }
    },
    ...
    parseDDS: function(e, t) {
        ...
        switch (w) {
            ...
            case u:
                ...
                break;
            default:
                console.error("ImageUtils.parseDDS(): Unsupported FourCC code: ", i(w));
                return n
        }
        n.mipmapCount = 1;
        ...
        for (var b = x[d] + 4, _ = n.width, S = n.height, M = n.isCubemap ? 6 : 1, C = 0; M > C; C++) {
            for (var A = 0; A < n.mipmapCount; A++) {
                var D = Math.max(4, _) / 4 * Math.max(4, S) / 4 * H,
                    L = new Uint8Array(e, b, D),
                    P = {
                        data: L,
                        width: _,
                        height: S
...
THREE.FontUtils = {
    ...
    extractGlyphPoints: function(e, t, r, i, n) {
        var o, a, s, l, c, h, u, f, p, d, m, E, g, v, y, T, R, x, H, w = [],
    ...
    for (r = 0, i = this.actions.length; i > r; r++) {
        ...
        switch (o) {
            ...
            case THREE.PathActions.CSPLINE_THRU:
                ...
                for (E = 1; H >= E; E++) T.push(w.getPointAt(E / H));
                break;
    ...
    removeHoles: function(e, t) {
        ...
        for (a = 0; a < t.length; a++) {
            ...
            var x = [l[n], v[o], v[r]],
                ...
                w = [l[n], l[i], v[o]],
                b = THREE.FontUtils.Triangulate.area(w),
                _ = 1,
                S = -1,
                M = o,
                C = n;
            ...
            w = [l[n], l[i], v[o]];
            var D = THREE.FontUtils.Triangulate.area(w);
            if (H + b > A + D) {
                o = M;
                n = C;
                0 > o && (o += v.length);
        ...
        for (u = 0; p > u; u++)
            for (h = 0; f > h; h++) {
                var H = h + g * u,
                    ...
                    b = h + 1 + g * (u + 1),
                    _ = h + 1 + g * u,
                    S = new THREE.Face4(H + E, w + E, b + E, _ + E);
                S.normal.copy(R);
    ...
    for (a = 0; i > a; a++) {
        ...
        for (s = 0; n > s; s++) {
            var T = c[s][a],
                ...
                A = h[s + 1][a + 1].clone(),
                D = h[s][a + 1].clone();
            this.faces.push(new THREE.Face4(T, R, x, H, [w, b, _, S]));
            this.faceVertexUvs[0].push([M, C, A, D])
        }
    }
    if (o === !1 && e > 0) {
        ...
        for (a = 0; i > a; a++) {
            ...
            this.faces.push(new THREE.Face3(T, R, x, [w, b, _]));
...
THREE.ExtrudeGeometry.prototype.addShape = function(e, t) {
    ...
    function c(e, t, r) {
        L.vertices.push(new THREE.Vector3(e, t, r))
    }
    ...
    function h(r, i, n, o) {
        ...
        i += P;
        n += P;
        L.faces.push(new THREE.Face3(r, i, n, null, null, _));
        var a = o ? M.generateBottomUV(L, e, t, r, i, n) : M.generateTopUV(L, e, t, r, i, n);
    ...
    function u(r, i, n, o, a, s, l, c, h) {
        ...
        n += P;
        o += P;
        L.faces.push(new THREE.Face4(r, i, n, o, null, null, S));
        var u = M.generateSideWallUV(L, e, a, t, r, i, n, o, s, l, c, h);
        L.faceVertexUvs[0].push(u)
    }
    ...
    this.shapebb;
    if (w) {
        f = w.getSpacedPoints(H);
        b = !0;
        R = !1;
        p = void 0 !== t.frames ? t.frames : new THREE.TubeGeometry.FrenetFrames(w, H, !1);
        d = new THREE.Vector3;
        m = new THREE.Vector3;
        E = new THREE.Vector3
    }
    ...
    for (O = T - 1; O >= 0; O--) {
        ...
        for (A = 0, D = U.length; D > A; A++) {
            ...
            for ($ = 0, K = C.length; K > $; $++) {
                G = r(C[$], J[$], k);
                b ? c(G.x, G.y + f[H - 1].y, f[H - 1].x + j) : c(G.x, G.y, g + j)
            }
        }
    }
    a();
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    ...
    generateSideWallUV: function(e, t, r, i, n, o, a, s, l, c, h, u) {
        var f = e.vertices[n].x,
            ...
            x = e.vertices[s].y,
            H = e.vertices[s].z;
        return Math.abs(p - E) < .01 ? [new THREE.Vector2(f, 1 - d), new THREE.Vector2(m, 1 - g), new THREE.Vector2(v, 1 - T), new THREE.Vector2(R, 1 - H)] : [new THREE.Vector2(p, 1 - d), new THREE.Vector2(E, 1 - g), new THREE.Vector2(y, 1 - T), new THREE.Vector2(x, 1 - H)]
    }
};
    ...
    for (l = 0; l < this.heightSegments; l++)
        for (s = 0; s < this.widthSegments; s++) {
            ...
            if (Math.abs(this.vertices[E].y) === this.radius) {
                ...
                this.faces.push(new THREE.Face4(E, g, v, y, [T, R, x, H]));
                this.faceVertexUvs[0].push([w, b, _, S])
            }
        }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.TorusKnotGeometry = function(e, t, r, i, n, o, a) {
    ...
    for (var p = 0; p < this.radialSegments; ++p)
        for (var d = 0; d < this.tubularSegments; ++d) {
            ...
            this.faces.push(new THREE.Face4(H, w, b, _));
...
THREE.TubeGeometry = function(e, t, r, i, n, o) {
    ...
    this.grid = [];
    var s, l, c, h, u, f, p, d, m, E, g, v, y, T, R, x, H, w, b, _, S = this,
        M = this.segments + 1,
        C = new THREE.Vector3,
    ...
    for (m = 0; m < this.segments; m++)
        for (E = 0; E < this.radiusSegments; E++) {
            ...
            R = this.grid[g][v];
            x = this.grid[m][v];
            H = new THREE.Vector2(m / this.segments, E / this.radiusSegments);
            w = new THREE.Vector2((m + 1) / this.segments, E / this.radiusSegments);
            ...
            this.faceVertexUvs[0].push([H, w, b, _])
        }
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
                ...
                if (n.hasVertexTexture || E.x > 0 && E.x < o && E.y > 0 && E.y < a) {
                    ...
                    for (T = 0, R = x.lensFlares.length; R > T; T++) {
                        ...
                        if (H.opacity > .001 && H.scale > .001) {
                            ...
                            t.uniform3f(g.screenPosition, m.x, m.y, m.z);
                            t.uniform2f(g.scale, d.x, d.y);
                            t.uniform1f(g.rotation, H.rotation);
                            t.uniform1f(g.opacity, H.opacity);
                            t.uniform3f(g.color, H.color.r, H.color.g, H.color.b);
                            r.setBlending(H.blending, H.blendEquation, H.blendSrc, H.blendDst);
                            r.setTexture(H.texture, 1);
                            t.drawElements(t.TRIANGLES, 6, t.UNSIGNED_SHORT, 0)
                        }
                    }
                }
...
THREE.ShadowMapPlugin = function() {
    ...
    this.update = function(f, p) {
        var m, E, g, v, y, T, R, x, H, w, b, _, S, M, C = [],
            A = 0,
            D = null;
            ...
            if (S.castShadow)
                if (S instanceof THREE.DirectionalLight && S.shadowCascade)
                    for (y = 0; y < S.shadowCascadeCount; y++) {
                        var L;
                        if (S.shadowCascadeArray[y]) L = S.shadowCascadeArray[y];
                        else {
                            L = e(S, y);
                            L.originalCamera = p;
                            ...
                            P.add(L.target);
                            p.add(P);
                            S.shadowCascadeArray[y] = L;
                            console.log("Created virtualLight", L)
                        }
                        t(S, y);
                        C[A] = L;
                        A++
        ...
        for (m = 0, E = C.length; E > m; m++) {
            ...
            S.isVirtual && L.originalCamera == p && r(p, S);
            T = S.shadowMap;
            R = S.shadowMatrix;
            x = S.shadowCamera;
            ...
            for (g = 0, v = M.length; v > g; g++) {
                ...
                if (b.render) {
                    ...
                    w = _.customDepthMaterial ? _.customDepthMaterial : z ? V ? c : l : V ? s : a;
                    H instanceof THREE.BufferGeometry ? o.renderBufferDirect(x, f.__lights, D, w, H, _) : o.renderBuffer(x, f.__lights, D, w, H, _)
                }
            }
            ...
            for (g = 0, v = M.length; v > g; g++) {
                ...
                if (_.visible && _.castShadow) {
                    _._modelViewMatrix.multiplyMatrices(x.matrixWorldInverse, _.matrixWorld);
                    o.renderImmediateObject(x, f.__lights, D, a, _)
                }
            }
        }
            ...
            for (v = 0; c > v; v++) {
                ...
                if (y.visible && 0 !== T.opacity && T.map && T.map.image && T.map.image.width) {
                    ...
                    if (T.useScreenCoordinates === !0) {
                        ...
                        H[0] = i.devicePixelRatio;
                        H[1] = i.devicePixelRatio
                    } else {
...
(function() {
    ...
    e.Viewer = function(o) {
        ...
        a.prototype.width = function() {
            return (window.parent === window ? 720 : void 0) || this.$().width() || $(window).width() || 540
        };
        a.prototype.height = function() {
            return (window.parent === window ? 600 : void 0) || (this.$().height() || $(window).height() || 500) - $(".js-render-bar").outerHeight()
        };
